...
describe GildedRose do
  ...
  describe '#update_quality' do
    ...
    vest = Item.new("+5 Dexterity Vest", 10, 20) #0
    ...
    pass2 = Item.new("Backstage passes to a TAFKAL80ETC concert", 10, 40) #5
    pass3 = Item.new("Backstage passes to a TAFKAL80ETC concert", 5, 46) #6
    cake = Item.new("Conjured Mana Cake", 3, 6) #7
    stock = GildedRose.new([vest, brie, elixir, sulfuras, pass1, pass2, pass3, cake])
    ...
    it 'quality of an item is <= 50' do
      expect(stock.items[0].quality).to be <=50
    end
    ...
    #   expect(stock.items[7].quality).to eq 4
    # end
